...
@NamedQueries({
    ...
    @NamedQuery(name = "MatriculasGym.cuentaActivos", query = "SELECT COUNT(*) FROM MatriculasGym m WHERE m.estado = true"),
    @NamedQuery(name = "MatriculasGym.orderFecha", query = "SELECT m FROM MatriculasGym m ORDER BY m.fechaAlta"),
    @NamedQuery(name = "MatriculasGym.selectPorMes", query = "SELECT COUNT(*) FROM MatriculasGym m WHERE extract(month from m.fechaAlta) = :mes"),
...
public class MatriculasGym implements Serializable {
    ...
    public String toString() {
        return "dev.muldev.appgestiongym.Clientes.MatriculasGym[ idmatricula=" + idmatricula + " ]";
    }
