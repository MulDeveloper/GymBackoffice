...
@NamedQueries({
    ...
    @NamedQuery(name = "PersonalGym.sumaSueldos", query = "SELECT sum(p.sueldoBruto) FROM PersonalGym p")})
public class PersonalGym implements Serializable {
    ...
    public String toString() {
        return "dev.muldev.appgestiongym.Personal.PersonalGym[ idpersonal=" + idpersonal + " ]";
    }
